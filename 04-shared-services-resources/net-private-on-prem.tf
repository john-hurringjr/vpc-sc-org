 ...
 */
/******************************************
  Private On Prem VPC - Prod
 *****************************************/
resource "google_compute_network" "private_on_prem_vpc_prod" {
  project                         = var.on_prem_project_id
  name                            = var.private_on_prem_prod_vpc_name
  routing_mode                    = "GLOBAL"
  auto_create_subnetworks         = false
  delete_default_routes_on_create = true
}

module "private_on_prem_vpc_prod_subnet_1" {
...
module "private_on_prem_vpc_prod_subnet_2" {
  source                = "github.com/john-hurringjr/test-modules/networking/subnet/generic"
  project_id            = var.on_prem_project_id
  network_self_link     = google_compute_network.private_on_prem_vpc_prod.self_link
  network_name          = google_compute_network.private_on_prem_vpc_prod.name
...
module "private_on_prem_vpc_prod_firewall_allow_iap_all" {
...
module "private_on_prem_vpc_prod_firewall_allow_ingress_rfc1918_limited" {
...
module "private_on_prem_prod_vpc_private_apis_dns" {
...
/******************************************
  Private On Prem VPC - Non-Prod
 *****************************************/
resource "google_compute_network" "private_on_prem_vpc_non_prod" {
  project                         = var.on_prem_project_id
  name                            = var.private_on_prem_non_prod_vpc_name
  routing_mode                    = "GLOBAL"
  auto_create_subnetworks         = false
  delete_default_routes_on_create = true
}

module "private_on_prem_non_prod_vpc_subnet_1" {
  source                = "github.com/john-hurringjr/test-modules/networking/subnet/generic"
  project_id            = var.on_prem_project_id
...
module "private_on_prem_non_prod_vpc_subnet_2" {
  source                = "github.com/john-hurringjr/test-modules/networking/subnet/generic"
  project_id            = var.on_prem_project_id
  network_self_link     = google_compute_network.private_on_prem_vpc_non_prod.self_link
  network_name          = google_compute_network.private_on_prem_vpc_non_prod.name
...
module "private_on_prem_non_prod_vpc_firewall_allow_iap_all" {
  source            = "github.com/john-hurringjr/test-modules/networking/firewall-rules/all/allow-ingress-iap"
  project_id        = var.on_prem_project_id
  network_self_link = google_compute_network.private_on_prem_vpc_non_prod.self_link
  network_name      = google_compute_network.private_on_prem_vpc_non_prod.name
...
module "private_on_prem_non_prod_vpc_firewall_allow_ingress_rfc1918_limited" {
  source            = "github.com/john-hurringjr/test-modules/networking/firewall-rules/all/allow-ingress-rfc1918-limited"
  project_id        = var.on_prem_project_id
  network_self_link = google_compute_network.private_on_prem_vpc_non_prod.self_link
  network_name      = google_compute_network.private_on_prem_vpc_non_prod.name
...
module "private_on_prem_non_prod_vpc_private_apis_dns" {
  source                    = "github.com/john-hurringjr/test-modules/networking/dns/internal-private-apis"
  project_id                = var.on_prem_project_id
  network_self_link         = google_compute_network.private_on_prem_vpc_non_prod.self_link
